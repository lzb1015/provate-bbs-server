...
// 登陆成功后生成token
function generateToken(userId, icon, nickName, identity) {
    return jwt.sign({ userId: userId, icon:icon, nickName:nickName, identity:identity }, config.secretKey, { expiresIn: '24h' });
}
